package com.cjt.carlauncher.view;
...
/**
 * @PackageName com.cjt.carlauncher.view
 * @ProjectName CarLauncher
 * @Author CaoJiangtao
 * @Date on 2017/11/14 15:11
...
//        panPaint.setColor(getResources().getColor(R.color.biaopan));
        panPaint.setColor(Color.parseColor("#2c436b"));
...
//        panPaint.setColor(getResources().getColor(R.color.biaopanwai));
        panPaint.setColor(Color.parseColor("#1e3251"));
